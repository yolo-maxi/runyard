...
const tools = [
  ...
  {
    name: "run_capability",
    description: "Run a capability with JSON input. Pass executionMode 'local' to target a local runner or 'remote' to target the shared remote/VPS runner pool. Outputs and artifacts are fetched from the Hub.",
    inputSchema: {
      type: "object",
      required: ["id"],
      properties: {
