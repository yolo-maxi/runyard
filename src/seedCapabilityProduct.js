export const seedProductCapabilities = [
  ...
  {
    "slug": "national-spirit-question-factory",
    "name": "National Spirit Question Factory",
    "description": "Turns National Spirit content holes, behavior signals, and grades into reviewable candidate questions.",
    "category": "Product",
    "keywords": [
      "national-spirit",
      "questions",
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "contentHoles": {
          "type": "array",
          "description": "Content holes exported by the National Spirit journey/lab.",
          "items": {
            "type": "object"
          }
        },
        "registry": {
          "type": "object",
          "description": "Optional vector/lens registry snapshot."
        },
        "lens": {
          "type": "string",
          "description": "Current discovery lens, e.g. travel-self."
        },
        "locale": {
          "type": "string",
          "description": "Locale/language to write for, e.g. en."
        },
        "acceptedExamples": {
          "type": "array",
          "items": {
          ...
          "description": "Accepted or high-scoring examples to imitate."
        },
        "rejectedExamples": {
          "type": "array",
          "items": {
          ...
          "description": "Rejected examples and failure reasons to avoid."
        },
        "behavioralSignals": {
          "type": "array",
          "items": {
          ...
          "description": "Implicit quality signals such as skip, dwell, changes, and drop-off."
        },
        "explicitGrades": {
          "type": "array",
          "items": {
          ...
          "description": "Explicit review grades and notes."
        },
        "batchSize": {
          "type": "number",
          "description": "Candidate count target, 1-12."
        }
      }
    },
    "outputSchema": {
    ...
    "approvalPolicy": {
      "required": false,
      "reason": "Creates draft candidate questions only; promotion into the app remains a separate review step."
    },
    "workflow": {
      "engine": "smithers",
      "entry": ".smithers/workflows/national-spirit-question-factory.tsx"
    }
  }
];
