...
export const seedCapabilities = [
  ...
  },
  {
    ...
    description:
      "Re-authenticate the runner host's Codex/Claude subscription login from the Hub. Runs the real device-auth / setup-token flow on the targeted runner, streams back the verification URL + user code, and writes the auth file on success. Admin only.",
    category: "Internal",
