...
export const MCP_TOOLS = [
  ...
  { name: "resume_run", description: "Resume a paused run: re-queues the same run and continues from the recorded engine checkpoint when one exists; otherwise it re-runs from scratch (the response's resume.strategy says which).", inputSchema: { type: "object", required: ["runId"], properties: { runId: { type: "string" } } } },
