---
title: MCP
description: Connect AI agents to a Runyard Hub with the runyard-mcp stdio server and its 85-tool surface.
---
...
The server exposes **85 tools**, generated from the same API surface registry
